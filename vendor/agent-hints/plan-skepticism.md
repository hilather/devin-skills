> Origin: `~/git/agent-skills/knowledge/plan-skepticism/README.md`. Cursor skill: `~/.cursor/skills/skeptic-plan-review/SKILL.md`. Refresh: `sh scripts/refresh-vendor.sh`.
